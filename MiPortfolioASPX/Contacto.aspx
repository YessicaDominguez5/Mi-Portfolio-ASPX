...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br>
    <p class="bienvenida">Llene el formulario de contacto y responderé a la brevedad.</p><br><br>
    ...
    <asp:TextBox ID="TxtMensaje" runat="server"></asp:TextBox><br><br>

        </div>
    
        <div>

    <asp:Button ID="BtnEnviar" runat="server" Text="ENVIAR" /><br><br>
